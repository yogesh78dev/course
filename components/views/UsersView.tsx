...
import { PlusIcon, EditIcon, DeleteIcon, KeyIcon } from '../icons';
...
const UsersView: React.FC = () => {
    ...
    const openEnrollmentModal = (user: User) => {
    ...
    // Dynamically generate filter tabs for student roles, excluding Admin
